...
const initialMemories: Memory[] = [
  {
    ...
    description: "The day we met at that cozy coffee shop downtown. You were wearing that green dress, and I couldn't stop smiling the entire time. We talked for hours and I knew right then that you were special.",
  ...
  },
  {
    id: "2", 
    title: "Beach Sunset",
    description: "Walking along the shore as the sun painted the sky in shades of orange and pink. You held my hand and said this was your favorite place. I've never felt more at peace.",
  ...
  },
  {
    ...
    description: "We conquered that hiking trail together. The view from the top was breathtaking, but nothing compared to seeing your smile when we reached the summit.",
  ...
  },
  {
    ...
    description: "One whole year of adventures, laughter, and love. We celebrated with dinner at that little Italian restaurant where they played our song. Here's to many more years together.",
    date: new Date("2024-06-15"),
    imageUrl: "https://images.unsplash.com/photo-1529636798458-92182e662485?w=800&auto=format&fit=crop"
  }
];
      ...
      <AlertDialog open={!!deleteConfirmId} onOpenChange={() => setDeleteConfirmId(null)}>
        <AlertDialogContent data-testid="dialog-delete-confirm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This memory will be permanently removed from your timeline.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
